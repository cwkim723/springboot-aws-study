...
import com.cwkim723.springbootstudy.config.auth.dto.OAuthAttributes;
import com.cwkim723.springbootstudy.config.auth.dto.SessionUser;
import com.cwkim723.springbootstudy.domain.user.User;
import com.cwkim723.springbootstudy.domain.user.UserRepository;
...
public class CustomOAuth2UserService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        System.out.println("loadUser 들어왔당");
